...

{
    private ApplicationDbContext CreateContext()
    {
        ...
        context.Posts.AddRange(
            new Post { Id = 1, Title = "First Post", Content = "First post content", Upvotes = 5, Downvotes = 1 },
            new Post { Id = 2, Title = "Second Post", Content = "Second post content", Upvotes = 10, Downvotes = 3 },
            new Post { Id = 3, Title = "Third Post", Content = "Third post content", Upvotes = 15, Downvotes = 5 });
